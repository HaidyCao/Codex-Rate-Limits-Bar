...
.PHONY: build test run open stop install-user uninstall-user install-plugin clean verify verify-local-usage verify-ui verify-bundle verify-live benchmark
...
verify: test verify-ui verify-bundle
